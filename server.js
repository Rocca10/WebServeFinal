...
app.set('view engine','hbs'); // Setea el motor de plantillas hbs (Handlebars)
...
app.get("/", (req, res) => {
    ...
    // let {nombre, edad} = usuario; // PPT de Javascript contemporaneo
    // Es buena practica que las referencias a objetos y arrays se guarden en constantes para evitar cambiarlas por accidente

    console.table(mensajes);
    //res.render("index.hbs", usuario);
    res.render("index.hbs", {
        mensajes, // PPT de Javascript contemporaneo,
        coloreado: true
    });
});

console.log(mensajes[0].fecha);